...
- Treat Datebook as a daily-use calendar/todo: native iOS-like polish, refined velocity-aware animations, and satisfying controls over generic web UI — tab switches, menus, and gestures should stay fluid with no stutter or choppiness.
