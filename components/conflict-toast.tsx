...
export function ConflictToast() {
  ...
  return (
    ...
    <div className="viewport-pinned-bottom pointer-events-none fixed inset-x-0 bottom-[calc(var(--safe-bottom)+var(--tab-bar-rest)+9.5rem)] z-50 flex justify-center px-4 md:bottom-[5.5rem]">
      <AnimatePresence>
        {lastConflict && (
          <motion.div
            key={lastConflict}
