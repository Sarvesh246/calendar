...
export function ConflictToast() {
  ...
  return (
    <div className="pointer-events-auto fixed bottom-[calc(env(safe-area-inset-bottom)+5.75rem)] left-1/2 z-40 w-[calc(100%-2rem)] max-w-[420px] -translate-x-1/2 rounded-xl border border-line bg-surface px-3.5 py-3 md:bottom-6">
