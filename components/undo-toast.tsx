...
export function UndoToast() {
  ...
  return (
    <div className="viewport-pinned-bottom pointer-events-none fixed inset-x-0 bottom-[calc(var(--safe-bottom)+var(--tab-bar-rest)+5.75rem)] z-50 flex justify-center px-4 md:bottom-6">
      <AnimatePresence>
        {lastDeleted && (
          <motion.div
